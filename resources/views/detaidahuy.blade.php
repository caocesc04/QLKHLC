                ...
                <table class="table table-striped table-bordered table-hover dataTables-example" >
                    ...
                    @foreach($thongtindetai as $ttdt)
                        <tr class="gradeX">
                            ...
                            <!-- <td class="center">
                                <a href="{{route('detaidahuy.edit', [$ttdt->ID])}}" class="btn btn-outline btn-success  dim" style=" padding: 1px 9px;"><i class="fa fa-paint-brush"></i></a>
                            </td> -->
                            <td class="center">
                                <form action="{{action('DeTaiDaHuyController@delete', $ttdt['ID'])}}" method="post">
                                {{csrf_field()}} 
