            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li  class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="/canbo">Cán Bộ</a></li>  
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <div class="col-lg-2" style="margin-top: 30px;">
                        ...
                        <form method="post" action="{{route('canbo.store')}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="modal inmodal fade" id="myModal5" tabindex="-1" role="dialog"  aria-hidden="true">
                                <div class="modal-dialog modal-lg" style="width: 600px;margin: 30px auto;">
                                    <div class="modal-content"style="border: 3px solid transparent;border-radius: 10px;    -webkit-box-shadow: 0 1px 1px rgba(0,0,0,.05);border-color: #1ab394;">
                                        <div class="modal-header"style="padding: 2px 6px;text-align: center;background-color: #1ab394;    border-color: #1ab394;">
                                            ...
                                            <h4 class="modal-title"style="color: #ffffff;">Thêm Cán Bộ</h4>
                                        </div>
                                        <div class="modal-body"style="padding: 1px 30px 1px 30px;">
                                                <div class="row show-grid">
                                                    <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #ececec; background-color: #fff !important;border:none">
                                                      <b><p>Tên Cán Bộ : </p></b>  
                                                        <input style="border-radius: 10px;" type="text" name="TenCB" class="form-control">
                                                    </div>                                           
                                                </div>
                                                <div class="row show-grid">
                                                    <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #ececec; background-color: #fff !important;border:none">
                                                      <b><p>Địa Chỉ : </p></b>  
                                                        <input style="border-radius: 10px;" type="text" name="DiaChiCB" class="form-control">
                                                    </div>                                           
                                                </div>
                                                <div class="row show-grid">
                                                    <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #ececec; background-color: #fff !important;border:none">
                                                      <b><p>Số Điện Thoại : </p></b>  
                                                        <input style="border-radius: 10px;" type="text" name="SDTCB" class="form-control">
                                                    </div>                                           
                                                </div>
                                                <div class="row show-grid">
                                                    <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #ececec; background-color: #fff !important;border:none">
                                                      <b><p>Chức Vụ: </p></b>  
                                                        <input style="border-radius: 10px;" type="text" name="ChucVuCB" class="form-control">
                                                    </div>                                           
                                                </div>
                                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    <thead>
                                        <tr style="font-size: 10px;">
                                              ...
                                              <th style="text-align: center;">Tên Cán Bộ</th>
                                    ...
                                    <tbody>
                                        @foreach($canbo as $canbos)
                                        <tr class="gradeX">
                                            <td style="text-align: center;">{{$canbos->ID}}</td>
                                            <td style="text-align: center;">{{$canbos->Ten}}</td>
                                            <td style="text-align: center;">{{$canbos->DiaChi}}</td>
                                            <td style="text-align: center;">{{$canbos->SoDienThoai}}</td>
                                            <td style="text-align: center;">{{$canbos->ChucVu}}</td>
                                            <td class="center" style="display: flex;align-items: center;justify-content: center;">
                                                <button class="btn btn-outline btn-success  dim open_modal" type="button" data-toggle="modal" style=" padding: 1px 9px;" value="{{$canbos->ID}}"><i class="fa fa-paint-brush"></i></button>
                                            </td>
                                            <td class="center" >
                                                <form action="{{action('CanBoController@delete', $canbos['ID'])}}" method="post">
                                                {{csrf_field()}} 
                                ...
                                <div class="modal inmodal" id="myModal2" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog" style="width: 600px;margin: 30px auto;">
                                        <div class="modal-content animated" style="border: 3px solid transparent;border-radius: 10px;    -webkit-box-shadow: 0 1px 1px rgba(0,0,0,.05);border-color: #1ab394;">
                                            <div class="modal-header" style="padding: 2px 6px;text-align: center;background-color: #1ab394;    border-color: #1ab394;">
                                                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                                <h4 style="color: #ffffff;">Sửa Thông Tin Cán Bộ </h4>
                                            </div>
                                            <div class="modal-body"style="padding: 1px 30px 1px 30px;">
                                                    <div class="row show-grid">
                                                        <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #ececec; background-color: #fff !important;border:none">
                                                          <b><p>Tên Cán Bộ : </p></b>  
                                                            <input style="border-radius: 10px;" type="text" name="TenCB" id="TenCB" class="form-control">
                                                        </div>                                           
                                                    </div>
                                                    <div class="row show-grid">
                                                        <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #ececec; background-color: #fff !important;border:none">
                                                          <b><p>Địa Chỉ : </p></b>  
                                                            <input style="border-radius: 10px;" type="text" name="DiaChiCB" id="DiaChiCB" class="form-control">
                                                        </div>                                           
                                                    </div>
                                                    <div class="row show-grid">
                                                        <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #ececec; background-color: #fff !important;border:none">
                                                          <b><p>Số Điện Thoại : </p></b>  
                                                            <input style="border-radius: 10px;" type="text" name="SDTCB" id="SDTCB" class="form-control">
                                                        </div>                                           
                                                    </div>
                                                    <div class="row show-grid">
                                                        <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #ececec; background-color: #fff !important;border:none">
                                                          <b><p>Chức Vụ : </p></b>  
                                                            <input style="border-radius: 10px;" type="text" name="ChucVuCB" id="ChucVuCB" class="form-control">
                                                        </div>                                           
                                                    </div>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <input type="hidden" id="dangkydetai_id" name="dangkydetai_id" value="0"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    $(document).ready(function(){
            ...
            $(document).on('click','.open_modal',function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#TenCB').val(data.Ten);
                        $('#DiaChiCB').val(data.DiaChi);
                        $('#SDTCB').val(data.SoDienThoai);
                        $('#ChucVuCB').val(data.ChucVu);
                        $('#save').val("update");
                        $('#myModal2').modal('show');
                    },
                    error: function (data) {
            ...
            $("#save").click(function (e) {
                ...
                var formData = {
                    ...
                    TenCB: $('#TenCB').val(),
                    DiaChiCB: $('#DiaChiCB').val(),
                    SDTCB: $('#SDTCB').val(),
                    ChucVuCB: $('#ChucVuCB').val(),
                }
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    success: function (data) {
                        var dangkydetai = '<tr id="dangkydetai' + data.ID + '"><td>' + data.TenCB + '</td><td>'+ data.DiaChiCB + '</td><td>'+ data.SDTCB + '</td><td>'+ data.ChucVuCB + '</td>';
