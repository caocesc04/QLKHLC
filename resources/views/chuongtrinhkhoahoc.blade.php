...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li  class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active" ><a href="/chuongtrinhkhoahoc">Chương Trình Khoa Học</a></li> 
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Chương Trình Khoa Học</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="dangkydetai.html">Trang Chủ</a>
                        </li>
                        <li class="active">
                            <strong>Chương Trình Khoa Học</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2" style="margin-top: 30px;">
                        ...
                        <form method="post" action="{{route('chuongtrinhkhoahoc.store')}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                                ...
                                <div class="modal-dialog modal-lg" style="width: 600px;margin: 30px auto;">
                                    <div class="modal-content"style="border: 3px solid transparent;border-radius: 10px;    -webkit-box-shadow: 0 1px 1px rgba(0,0,0,.05);border-color: #1ab394;">
                                        <div class="modal-header"style="padding: 2px 6px;text-align: center;background-color: #1ab394;    border-color: #1ab394;">
                                            ...
                                            <h4 class="modal-title"style="color: #ffffff;">Thêm Chương Trình Khoa Học</h4>
                                        </div>
                                            ...
                                            <form method="get" class="form-horizontal">
                                                <div class="row show-grid">
                                                    <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #ececec; background-color: #fff !important;border:none">
                                                      <b><p>Tên Chương Trình Khoa Học : </p></b>  
                                                        <input style="border-radius: 10px;" type="text" name="ChuongTrinhKhoaHoc" class="form-control">
                                                    </div>                                           
                                                </div>
                                            </form>
                                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    <thead>
                                        <tr style="font-size: 10px;">
                                              ...
                                              <th style="text-align: center;">Tên Chương Trình Khoa Học</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX">
                                            <td style="text-align: center;">{{$ctkhs->ID}}</td>
                                            <td>{{$ctkhs->TenCTKH}}</td>
                                            <td>{{$ctkhs->status}}</td>
                                            <td class="center" style="display: flex;align-items: center;justify-content: center;">
                                                <button class="btn btn-outline btn-success  dim open_modal" type="button" data-toggle="modal" style=" padding: 1px 9px;" value="{{$ctkhs->ID}}"><i class="fa fa-paint-brush"></i></button>
                                            </td>
                                            <td class="center" >
                                                <form action="{{action('ChuongTrinhKhoaHocController@delete', $ctkhs['ID'])}}" method="post">
                                                {{csrf_field()}} 
                                ...
                                <div class="modal inmodal" id="myModal2" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog" style="width: 600px;margin: 30px auto;">
                                        <div class="modal-content animated" style="border: 3px solid transparent;border-radius: 10px;    -webkit-box-shadow: 0 1px 1px rgba(0,0,0,.05);border-color: #1ab394;">
                                            <div class="modal-header" style="padding: 2px 6px;text-align: center;background-color: #1ab394;    border-color: #1ab394;">
                                                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                                <h4 style="color: #ffffff;">Sửa Chương Trình Khoa Học </h4>
                                            </div>
                                            <div class="modal-body"style="padding: 1px 30px 1px 30px;">
                                                <form method="get" class="form-horizontal">
                                                    <div class="row show-grid">
                                                        <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #ececec; background-color: #fff !important;border:none">
                                                          <b><p>Tên Chương Trình Khoa Học </p></b>  
                                                            <input style="border-radius: 10px;" type="text" name="ChuongTrinhKhoaHoc" id="ChuongTrinhKhoaHoc" class="form-control">
                                                        </div>
                                                        <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #ececec; background-color: #fff !important;border:none">
                                                          <b><p>Trạng Thái </p></b>
                                                            <div id="rates">
                                                                <div class="i-checks"><label> <input type="radio" value="Đang Diễn Ra" id="r1" name="status"> Đang Diễn Ra </label></div>
                                                                <div class="i-checks"><label> <input type="radio" value="Đã Kết Thúc" id="r2" name="status"> Đã Kết Thúc </label></div>  
                                                            </div>
                                                            <input id="results" type="hidden"></input>
                                                        </div>                           
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <input type="hidden" id="dangkydetai_id" name="dangkydetai_id"
                                                value="0"></div>
                                        </div>
                                    </div>
                                </div>
    ...
    $(document).on('click','.open_modal',function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#ChuongTrinhKhoaHoc').val(data.TenCTKH);
                $('#save').val("update");
                $('#myModal2').modal('show');

                if (data.status == 'Đang Diễn Ra'){
                    $('#rates').find(':radio[name=status][value="Đang Diễn Ra"]').prop('checked', true);
                }
                else{
                    $('#rates').find(':radio[name=status][value="Đã Kết Thúc"]').prop('checked', true);
                }
                $('#rates').val(data.status);
            },
            error: function (data) {
    ...
    $("#save").click(function (e) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function (data) {
                var dangkydetai = '<tr id="dangkydetai' + data.ID + '"><td>' + data.ChuongTrinhKhoaHoc + '</td><td>' + data.status + '</td>';
