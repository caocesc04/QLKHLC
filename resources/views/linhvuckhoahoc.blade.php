...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
                ...
                <li >
                 ...
                 <li  class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="linhvuckhoahoc">Lĩnh Vực Khoa Học</a></li>
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Lĩnh Vực Khoa Học</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="dangkydetai.html">Trang Chủ</a>
                        </li>
                        <li class="active">
                            <strong>Lĩnh Vực Khoa Học</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2" style="margin-top: 30px;">
                        ...
                        <form method="post" action="{{route('linhvuckhoahoc.store')}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                                ...
                                <div class="modal-dialog modal-lg" style="width: 300px;margin: 30px auto;">
                                    <div class="modal-content"style="border: 3px solid transparent;border-radius: 10px;    -webkit-box-shadow: 0 1px 1px rgba(0,0,0,.05);border-color: #1ab394;">
                                        <div class="modal-header"style="padding: 2px 6px;text-align: center;background-color: #1ab394;    border-color: #1ab394;">
                                            ...
                                            <h4 class="modal-title"style="color: #ffffff;">Thêm Lĩnh Vực Khoa Học</h4>
                                        </div>
                                            ...
                                            <form method="get" class="form-horizontal">
                                                <div class="row show-grid">
                                                    <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #ececec; background-color: #fff !important;border:none">
                                                      <b><p>Tên Lĩnh Vực Khoa Học : </p></b>  
                                                        <input style="border-radius: 10px;" type="text" name="LinhVucKhoaHoc" class="form-control">
                                                    </div>                                           
                                                </div>
                                            </form>
                                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    <thead>
                                        <tr style="font-size: 10px;">
                                              ...
                                              <th style="text-align: center;">Tên Lĩnh Vực Khoa Học</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX">
                                            <td style="text-align: center;">{{$lvkhs->ID}}</td>
                                            <td style="text-align: center;">{{$lvkhs->TenLVKH}}</td>
                                            <td class="center" style="display: flex;align-items: center;justify-content: center;">
                                                <button class="btn btn-outline btn-success  dim open_modal" type="button" data-toggle="modal" style=" padding: 1px 9px;" value="{{$lvkhs->ID}}"><i class="fa fa-paint-brush"></i></button>
                                            </td>
                                            <td class="center" >
                                                <form action="{{action('LinhVucKhoaHocController@delete', $lvkhs['ID'])}}" method="post">
                                                {{csrf_field()}} 
                                ...
                                <div class="modal inmodal" id="myModal2" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog" style="width: 300px;margin: 30px auto;">
                                        <div class="modal-content animated" style="border: 3px solid transparent;border-radius: 10px;    -webkit-box-shadow: 0 1px 1px rgba(0,0,0,.05);border-color: #1ab394;">
                                            <div class="modal-header" style="padding: 2px 6px;text-align: center;background-color: #1ab394;    border-color: #1ab394;">
                                                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                                <h4 style="color: #ffffff;">Sửa Lĩnh Vực Khoa Học </h4>
                                            </div>
                                            <div class="modal-body"style="padding: 1px 30px 1px 30px;">
                                                <form method="get" class="form-horizontal">
                                                    <div class="row show-grid">
                                                        <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #ececec; background-color: #fff !important;border:none">
                                                          <b><p>Tên Lĩnh Vực Khoa Học : </p></b>  
                                                            <input style="border-radius: 10px;" type="text" name="LinhVucKhoaHoc" id="LinhVucKhoaHoc" class="form-control">
                                                        </div>                                           
                                                    </div>
                                                </form>
                                            </div>
    ...
    $(document).on('click','.open_modal',function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#LinhVucKhoaHoc').val(data.TenLVKH);
                $('#save').val("update");
                $('#myModal2').modal('show');
            },
            error: function (data) {
    ...
    $("#save").click(function (e) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function (data) {
                var dangkydetai = '<tr id="dangkydetai' + data.ID + '"><td>' + data.LinhVucKhoaHoc + '</td>';
